  ...
  return (
    <section className="sec" style={{ position: "relative" }}>
      <div className="wrap" style={{ position: "relative", zIndex: 1 }}>
        ...
        <h1 className="h2" style={{ fontSize: "clamp(2rem, 5.5vw, 3.2rem)" }}>{c.title}</h1>
        <p className="lede" style={{ marginBottom: "2.8rem" }}>{c.lede}</p>

        <div className="grid2" style={{ alignItems: "start", gap: "2.5rem" }}>
          {state === "sent" ? (
            <div className="card" style={{ padding: "2.4rem", borderColor: "rgba(52,211,153,0.3)" }}>
              <p style={{ display: "flex", alignItems: "center", gap: "0.6rem", color: "var(--ok)", fontWeight: 700 }}>
            ...
            <form onSubmit={submit} style={{ display: "grid", gap: "1rem" }} noValidate>
              <div className="grid2" style={{ gap: "1rem" }}>
                <div className="field">
                  ...
                  <input id="cn" className="inp" value={f.name} onChange={set("name")} required />
                </div>
                <div className="field">
                  <label htmlFor="cc">{c.clinicL}</label>
                  <input id="cc" className="inp" value={f.clinic} onChange={set("clinic")} />
                </div>
              </div>
              ...
              <div className="grid2" style={{ gap: "1rem" }}>
                <div className="field">
                  ...
                  <input id="cp" className="inp mono" dir="ltr" inputMode="tel"
                    value={f.phone} onChange={set("phone")} required />
                </div>
                <div className="field">
                  <label htmlFor="ce">{c.emailL}</label>
                  <input id="ce" className="inp" dir="ltr" type="email"
              ...
              <div className="field">
                ...
                <textarea id="cm" className="ta" value={f.message} onChange={set("message")}
              ...
              <button type="submit" className="btn btn--pri" disabled={busy} style={{ justifySelf: "start" }}>
          ...
          <div className="card" style={{ padding: "1.8rem" }}>
            <p className="foot__h">{c.directTitle}</p>
            <div style={{ display: "grid", gap: "1rem", marginTop: "0.4rem" }}>
              <a href={`mailto:${c.emailV}`} style={{ display: "flex", gap: "0.7rem", alignItems: "center", fontSize: "0.9rem", color: "var(--tx-2)" }}>
                <Mail size={16} style={{ color: "var(--blue-lit)" }} />
                <span dir="ltr">{c.emailV}</span>
              </a>
              <a href={`https://instagram.com/${c.instaV}`} target="_blank" rel="noopener noreferrer"
                style={{ display: "flex", gap: "0.7rem", alignItems: "center", fontSize: "0.9rem", color: "var(--tx-2)" }}>
                <AtSign size={16} style={{ color: "var(--blue-lit)" }} />
