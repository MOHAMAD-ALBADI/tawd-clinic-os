...
/* updateMyProfile and changeMyPassword used to live here. They are now in
   app/actions/profile.ts, shared by every role — the doctor's copies edited
   fewer fields and changed a password without asking for the current one. */
