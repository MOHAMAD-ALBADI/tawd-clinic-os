...
export const metadata = { title: "قوالب الرسائل — طود" };
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div>
        ...
        <p className="text-sm mt-0.5" style={{ color: "rgba(148,163,184,0.55)" }}>
          قوالب إشعارات واتساب / SMS / بريد — مُدارة عبر n8n
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        >
          <div
            ...
            style={{ fontSize: "4rem", color: "#14b8a6", opacity: 0.07, lineHeight: 1 }}
          >
            {templates.length}
          </div>
          <p className="text-[10px] font-bold uppercase tracking-widest mb-3 relative" style={{ color: "rgba(148,163,184,0.4)" }}>
            الإجمالي
          </p>
          <p className="font-black ltr-nums text-4xl relative" style={{ color: "#5dd9cb", lineHeight: 1 }}>
            {templates.length}
          </p>
        </div>
        ...
        >
          <div
            className="absolute bottom-1 start-1 font-black ltr-nums select-none pointer-events-none"
            style={{ fontSize: "4rem", color: "#4ADE80", opacity: 0.07, lineHeight: 1 }}
          >
            {active}
          </div>
          <p className="text-[10px] font-bold uppercase tracking-widest mb-3 relative" style={{ color: "rgba(148,163,184,0.4)" }}>
          ...
          <p className="font-black ltr-nums text-4xl relative" style={{ color: "#4ADE80", lineHeight: 1 }}>
            {active}
          </p>
        </div>
        ...
        >
          <div
            className="absolute bottom-1 start-1 font-black ltr-nums select-none pointer-events-none"
            style={{ fontSize: "4rem", color: "#6B7280", opacity: 0.07, lineHeight: 1 }}
          >
            {inactive}
          </div>
          <p className="text-[10px] font-bold uppercase tracking-widest mb-3 relative" style={{ color: "rgba(148,163,184,0.4)" }}>
          ...
          <p className="font-black ltr-nums text-4xl relative" style={{ color: "#6B7280", lineHeight: 1 }}>
            {inactive}
          </p>
        </div>
        ...
        >
          <p className="text-[10px] font-bold uppercase tracking-widest mb-3" style={{ color: "rgba(148,163,184,0.4)" }}>
            القنوات
          </p>
            ...
            {Object.entries(byChannel).map(([ch, cnt]) => {
              ...
              return (
                <div key={ch} className="flex items-center justify-between">
                  ...
                  <span className="font-black ltr-nums text-sm" style={{ color: c.color }}>
                    {cnt}
                  </span>
                </div>
              );
          ...
          <div className="flex flex-col items-center justify-center py-24 gap-4">
            ...
            <div className="text-center">
              ...
              <p className="text-sm mt-1" style={{ color: "#334155" }}>
                القوالب تُضاف عبر n8n أو مباشرةً في Supabase
              </p>
            </div>
          </div>
        ) : (
              ...
              return (
                <div key={t.id} className="px-5 py-4 flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {/* Body preview — prefer Arabic */}
                    {(t.body_ar || t.body_en) && (
                      <p
                        className="text-xs line-clamp-2 mt-1"
                        style={{ color: "#334155", direction: t.body_ar ? "rtl" : "ltr" }}
                      >
                        {(t.body_ar || t.body_en).substring(0, 120)}
                        {(t.body_ar || t.body_en).length > 120 ? "…" : ""}
                      </p>
                    )}
                  </div>
                </div>
